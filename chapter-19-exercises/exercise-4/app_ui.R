...
# This layout will contain the following elements:
  ...
  # the USThe below diagram was created."
  p("The below diagram was created
     by the New York Times to illustrate the increasing level of inequality in
     the US"),
  # An image `img()` to display. This content should have a  attribute of
...
#Define a variable sidebar_contentas a sidebarPanel() UI element
# containing the following information:
 sidebar_content <- sidebarPanel(
    sliderInput (inputId = "pecentile", label = "Income Percentile", min = 0, max = 100, value = c(0,100))
    )
 ...
 growth_panel <- tabPanel(
  ...
  # This slider should let the user pick a range between 0 and 10
  # Define a variable main_content asa mainPanel() UI element
  # containing the following information:
